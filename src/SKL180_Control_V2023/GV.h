...
extern int
    ...
    stepsXCalibrateLine1,                   // NUMERO DE PASOS AVANCE X PARA CENTRAR X AL CENTRO LINEA 1 (CON RELACION AL SENSOR)
    stepsXCalibrateLine2,                   // NUMERO DE PASOS AVANCE X PARA CENTRAR X AL CENTRO LINEA 2 (CON RELACION AL SENSOR)
    stepsXCalibrateLine3,                   // NUMERO DE PASOS AVANCE X PARA CENTRAR X AL CENTRO LINEA 3 (CON RELACION AL SENSOR)
    stepsXCalibrateLine4,                   // NUMERO DE PASOS AVANCE X PARA CENTRAR X AL CENTRO LINEA 4 (CON RELACION AL SENSOR)
