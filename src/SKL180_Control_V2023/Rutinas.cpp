...
// MÉTODO PARA RUTINA PRUEBA SKL-180 (RECOGER TUBO EN LINEA, LLEVARLO A SISTEMA ROTULACION [SIN SOLTARLO], DEVOLVERLO A SU LINEA)
void Rutinas::RecogerYDevolverTubo(String VLinea)
{
    bool HMGl1 = false;
    bool HMGl2 = false;
    bool HMG21 = false;
...
//Rutina para sistema de rotulacion sin tubos
...
//Rutina sensores prueba IOT por andres
void Rutinas::procesoIOTpruebaSensores()
{
    for (int i=0; i<=2; i++)
    {
        varIOT[i] = "1";
...
//Rutina proceso prueba IOT para andres
void Rutinas::procesoIOTprueba()
{
    for (int i=0; i<=16; i++)
    {
        varIOT[i] = "1";
